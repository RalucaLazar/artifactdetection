...
public enum RegionNew {
    ...
    F(Arrays.asList(2, 3, 4, 5, 9, 10, 11, 12, 16, 18, 19, 22, 23, 24, 26, 27, 123, 124)),
    C(Arrays.asList(6, 7, 13, 20, 28, 29, 30, 34, 35, 36, 41, 103, 104, 105, 106, 110, 111, 112, 116, 117, 118)),
    P(Arrays.asList(31, 37, 42, 47, 51, 52, 53, 54, 55, 61, 62, 78, 79, 80, 86, 87, 92, 93, 97, 98)),
    O(Arrays.asList(58, 59, 60, 64, 65, 66, 67, 70, 71, 72, 75, 76, 77, 83, 84, 85, 90, 91, 95, 96)),
